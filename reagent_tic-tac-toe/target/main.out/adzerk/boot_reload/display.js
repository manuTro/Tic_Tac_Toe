...
var attr = cljs.core.nth.call(null,vec__6475,(0),null);
var v = cljs.core.nth.call(null,vec__6475,(1),null);
...
var args6476 = [];
var len__6046__auto___6479 = arguments.length;
var i__6047__auto___6480 = (0);
while(true){
if((i__6047__auto___6480 < len__6046__auto___6479)){
args6476.push((arguments[i__6047__auto___6480]));

var G__6481 = (i__6047__auto___6480 + (1));
i__6047__auto___6480 = G__6481;
continue;
} else {
}
break;
...
var len__6046__auto___6484 = arguments.length;
var i__6047__auto___6485 = (0);
while(true){
if((i__6047__auto___6485 < len__6046__auto___6484)){
args__6053__auto__.push((arguments[i__6047__auto___6485]));

var G__6486 = (i__6047__auto___6485 + (1));
i__6047__auto___6485 = G__6486;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq6483){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6483));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__6487){
var map__6491 = p__6487;
var map__6491__$1 = ((((!((map__6491 == null)))?((((map__6491.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6491.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6491):map__6491);
var data = map__6491__$1;
var message = cljs.core.get.call(null,map__6491__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__6491__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6491__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__6493 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__6493,goog.events.EventType.CLICK,((function (G__6493,map__6491,map__6491__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__6493,map__6491,map__6491__$1,data,message,line,file))
);

return G__6493;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__6494){
var map__6498 = p__6494;
var map__6498__$1 = ((((!((map__6498 == null)))?((((map__6498.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6498.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6498):map__6498);
var data = map__6498__$1;
var message = cljs.core.get.call(null,map__6498__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__6498__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6498__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__6500 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__6500,goog.events.EventType.CLICK,((function (G__6500,map__6498,map__6498__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__6500,map__6498,map__6498__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__6501){
var map__6505 = p__6501;
var map__6505__$1 = ((((!((map__6505 == null)))?((((map__6505.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6505.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6505):map__6505);
var messages = map__6505__$1;
var warnings = cljs.core.get.call(null,map__6505__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6505__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__6507 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__6507,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__6507,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__6508){
var map__6511 = p__6508;
...
var messages = map__6511__$1;
var warnings = cljs.core.get.call(null,map__6511__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6511__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__6511,map__6511__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__6511,map__6511__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__6511,map__6511__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__6511,map__6511__$1,messages,warnings,exception))
;
...
}catch (e6514){if((e6514 instanceof Error)){
var __6515 = e6514;
} else {
throw e6514;
